pipeline {
    ...
    stages {
        ...
        stage('Image') {            
            steps {
                googleCloudBuild credentialsId: 'cto-opus-frictionless-lab-47f9', request: file('cloudbuild.yaml'), source: local('/bitnami/jenkins/home/workspace/microservice-build-deploy'), substitutions: [_SUB_VALUE: '1.0.1']
